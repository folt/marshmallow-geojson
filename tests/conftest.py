"""Shared fixtures and utilities for GeoJSON schema tests."""
...
@pytest.fixture()
def get_point_data(valid_point_data):
    """Legacy fixture for backward compatibility."""
    return valid_point_data
...
# Legacy fixtures
@pytest.fixture()
def get_line_string_data(valid_linestring_data):
    """Legacy fixture for backward compatibility."""
    return valid_linestring_data
...
# Legacy fixtures
@pytest.fixture()
def get_polygon_data(valid_polygon_data):
    """Legacy fixture for backward compatibility."""
    return valid_polygon_data
...
# Legacy fixtures
@pytest.fixture()
def get_multi_point_data(valid_multi_point_data):
    """Legacy fixture for backward compatibility."""
    return valid_multi_point_data
...
# Legacy fixtures
@pytest.fixture()
def get_multi_line_string_data(valid_multi_line_string_data):
    """Legacy fixture for backward compatibility."""
    return valid_multi_line_string_data
...
# Legacy fixtures
@pytest.fixture()
def get_multi_polygon_data(valid_multi_polygon):
    """Legacy fixture for backward compatibility."""
    return valid_multi_polygon
...
def valid_feature_type_only():
    ...
    return {"type": "Feature", "geometry": None, "properties": None}
...
# Legacy fixtures
@pytest.fixture()
def get_feature_data(valid_feature_all_fields):
    """Legacy fixture for backward compatibility."""
    return valid_feature_all_fields
...
# Legacy fixtures
@pytest.fixture()
def get_feature_collection_data(valid_feature_collection_data):
    """Legacy fixture for backward compatibility."""
    return valid_feature_collection_data
...
def nested_geometry_collection_data(sample_coordinate_2d):
    ...
    Can be used both for GeometryCollectionSchema tests and Feature tests.
    """
    return {
        "type": "GeometryCollection",
        "geometries": [
...
# Legacy fixtures
@pytest.fixture()
def get_geometry_collection_data(valid_geometry_collection_data):
    """Legacy fixture for backward compatibility."""
